...
export const monumentTemplates: TeamBuildTemplate[] = [
  ...
  },
  {
    ...
    buildId: "harbor_lighthouse_001",
    version: 1,
    name: "Harbor Lighthouse",
    shortName: "Lighthouse",
    description: "Raise a coastal tower from the stone base to the lantern room.",
    imagePath: "/team-monument-victory-obelisk.png",
    accentColor: "#2563eb",
    majorProjects: [{ id: "lighthouse", name: "Lighthouse", phases: stackedStonePhases }],
  },
  {
    id: "atlas_bridge",
    buildId: "atlas_bridge_001",
    version: 1,
    name: "Atlas Bridge",
    shortName: "Bridge",
    description: "Span a canyon with piers, arches, and a finished deck.",
    imagePath: "/team-monument-founders-arch.png",
    accentColor: "#7c3aed",
    majorProjects: [{ id: "bridge", name: "Bridge", phases: stackedStonePhases }],
  },
  {
    id: "starfall_tower",
    buildId: "starfall_tower_001",
    version: 1,
    name: "Starfall Tower",
    shortName: "Tower",
    description: "Build a tall observatory from foundation rings to the star chamber.",
    imagePath: "/team-monument-sunstone-pyramid.png",
    accentColor: "#be123c",
    majorProjects: [{ id: "tower", name: "Tower", phases: stackedStonePhases }],
  },
];
